...
function RootLayoutNav() {
  ...
  return (
    <Stack>
      ...
      <Stack.Screen name="orderDetails" options={{ headerShown: false, statusBarTranslucent: true, statusBarStyle: "dark" }} />
      ...
      <Stack.Screen name="productDetailsPage" options={{ headerShown: false, statusBarStyle: "dark" }} />
