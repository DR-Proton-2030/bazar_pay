...
import { createCategory, deleteCategoryById, editCategoryById, getCategories, getCategoryById, searchByCategory } from "../../controllers/category/category.controllers";
...
router.route("/search-category-list").get(searchByCategory);
