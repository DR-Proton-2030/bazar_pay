...
export const createWholeslaerEmployee = async (req: Request, res: Response) => {
    try {
        const userDetails = req.body;
        const adminInstance = await WholeSalerEmployeeModel.findOne({phone_number: userDetails.phone_number});
        if(adminInstance){
