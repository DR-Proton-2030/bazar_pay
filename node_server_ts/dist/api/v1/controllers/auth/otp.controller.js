...
exports.getOtpForRetailer = exports.getOtp = void 0;
...
const getOtp = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const employeeInstance = yield wholesaler_model_1.default.findOne({
            phone_number
        });
        if (employeeInstance) {
        ...
        const urlWithDynamicMessage = `${config_1.msg_apiUrl}?apiKey=${config_1.msg_apiKey}&type=${config_1.msg_type}&contactNumbers=${(phone_number === null || phone_number === void 0 ? void 0 : phone_number.length) === 10 ? "880" + phone_number : phone_number}&senderId=${config_1.msg_senderId}&textBody=${encodeURIComponent(dynamicMessage)}`;
...
const getOtpForRetailer = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { phone_number } = req.query;
    try {
        const employeeInstance = yield retailer_model_1.default.findOne({
...
exports.getOtpForRetailer = getOtpForRetailer;
