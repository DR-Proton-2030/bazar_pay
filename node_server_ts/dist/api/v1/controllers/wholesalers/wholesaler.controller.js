...
const createWholesaler = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        try {
            ...
            const tradeLicensceUrl = yield (0, uploadImageService_1.uploadImageService)("trade_licensce", tradeLicensceBuffer);
            const nidUrl = yield (0, uploadImageService_1.uploadImageService)("nid", nidBuffer);
            const visiting_card_url = yield (0, uploadImageService_1.uploadImageService)("visiting_card", visiting_cardBuffer);
