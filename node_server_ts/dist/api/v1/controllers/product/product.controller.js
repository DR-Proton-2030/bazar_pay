...
exports.getProductListForRetailers =
...
const { QUERY_PARAMS } = require("../../../../constants/query");
const createProduct = (req, res) =>
	__awaiter(void 0, void 0, void 0, function* () {
		try {
			...
			let payload = {};
			try {
				const productImageUrl = yield (0, uploadImageService_1.uploadImageToS3Service)(
					"product_image",
					productImageBuffer
				);
				const barCodePhotoUrl = yield (0, uploadImageService_1.uploadImageToS3Service)(
					"bar_code_photo",
					barCodePhotoBuffer
				);
				payload = Object.assign(Object.assign({}, productPayload), {
...
const updateProduct = (req, res) =>
	__awaiter(void 0, void 0, void 0, function* () {
		try {
			...
			if (productImageUrl) {
				productDetailsPayload = Object.assign(Object.assign({}, productDetailsPayload), {
					product_image: productImageUrl
				});
			}
			if (barCodePhotoUrl) {
			...
			const productInstance = yield product_model_1.default.findByIdAndUpdate(
				productId,
				{
...
const deleteProduct = async (req, res) => {
	try {
		const productId = req.query[QUERY_PARAMS.id];
		const deletedProduct = await product_model_1.findByIdAndDelete(productId);
		if (!deletedProduct) {
			return res.status(404).json({
