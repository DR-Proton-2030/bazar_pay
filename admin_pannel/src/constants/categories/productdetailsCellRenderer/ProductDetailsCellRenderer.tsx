...
const ProductDetailsCellRenderer = ({data}:{data: ICategory}) => {
    ...
    const handleRouteToSubcategoryDetails = () =>{
        navigate(`/product-details?cid=${data._id}`)
    }
  return (
    <Button variant="outlined" className='blue-outlined-button' onClick={handleRouteToSubcategoryDetails}>See Products</Button>
  )
}
